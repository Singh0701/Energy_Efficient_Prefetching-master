...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
	...
	//{
			...
			cout << cache->NAME;
			cout << "prefetch_cycle_count: " << cache->prefetch_cycle_count << " prefetches_per_prefetch_cycle: " << (float(cache->pf_issued)/cache->prefetch_cycle_count) << endl;
