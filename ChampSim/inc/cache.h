...
class CACHE : public MEMORY {
  public:
	...
	uint64_t prefetcher_accuracy_value_at_the_start_of_interval, 
		 prefetcher_lateness_value_at_the_start_of_interval, 
		 prefetcher_pollution_value_at_the_start_of_interval,
		 prefetcher_accuracy_value_during_interval,
		 prefetcher_lateness_value_during_interval,
		 pollution_total,
	         demand_total_misses,
		 dynamic_config_counter,
		 eviction_count,
...
//	mshr_full = 0;
	...
	prefetcher_accuracy_value_at_the_start_of_interval = 0; 
	prefetcher_lateness_value_at_the_start_of_interval = 0; 
	prefetcher_pollution_value_at_the_start_of_interval = 0; 
	pref_total = 0;
	used_total = 0; 
	late_total = 0; 
	pollution_total = 0;
	demand_total_misses = 0; 
	dynamic_config_counter = 3;
	eviction_count = 0; 

	prefetch_cycle_count = 0; 
