...
class ooo_model_instr {
  public:
    ...
    //Neelu: For CATCH implementation
    uint64_t add_to_rob_timestamp, execution_inflight_timestamp, execution_completed_timestamp, instr_commit_timestamp;
    bool rob_full_on_add_to_rob_attempt, l2_or_llc_hit; 
	...
	add_to_rob_timestamp = 0; 
	execution_inflight_timestamp = 0; 
	execution_completed_timestamp = 0; 
	instr_commit_timestamp = 0;
	rob_full_on_add_to_rob_attempt = false;
	l2_or_llc_hit = false; 
