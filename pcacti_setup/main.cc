...
int main(int argc,char *argv[])
{
  ...
  if (argc != 55)
  {
    ...
    if (infile_specified == false)
    {
      ...
      cerr << "  1) cacti -infile <input file name> -outfile <output file name>" << endl;
      cerr << "  2) cacti arg1 ... arg54 -- please refer to the README and README_BY_NEELU file" << endl;
	...
	cerr << " Invalid arguments -- how to use CACTI:" << endl;
      cerr << "  1) cacti -infile <input file name> -outfile <output file name>" << endl;
      cerr << "  2) cacti arg1 ... arg54 -- please refer to the README and README_BY_NEELU files" << endl;
      cerr << " No. of arguments input - " << argc << endl;
      exit(1);
    }
  }
